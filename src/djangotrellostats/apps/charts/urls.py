...
from djangotrellostats.apps.charts.views import members, cards, labels, public
...
urlpatterns = [
    ...
    url(r'^spent_time_by_week/?$', members.spent_time_by_week, name="spent_time_by_week"),
