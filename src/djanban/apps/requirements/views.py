...
def view_list(request, board_id):
    ...
    replacements = {"member": member, "board": board, "requirements": requirements}
...
def view(request, board_id, requirement_code):
    ...
    replacements = {"member": member, "board": board, "requirement": requirement}
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return HttpResponseRedirect(
                reverse("boards:requirements:view_requirements", args=(board_id,))
            )
    else:
...
def delete(request, board_id, requirement_code):
    ...
    return render(
        request,
        "requirements/delete.html",
        {"form": form, "board": board, "member": member, "requirement": requirement},
    )
