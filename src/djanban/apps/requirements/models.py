...
class Requirement(models.Model):
    board = models.ForeignKey("boards.Board", on_delete=models.CASCADE, verbose_name="Board", related_name="requirements")

    code = models.CharField(max_length=16, verbose_name="Unique code of this requirement", unique=True)

    name = models.CharField(max_length=256, verbose_name="Name of this requirement")

    description = models.TextField(verbose_name="Description of this requirement",
                                   help_text="Long description of this requirement describing behavior or "
                                             "pointing to other resources.")

    other_comments = models.TextField(verbose_name="Comments", default="", blank=True,
    ...
    value = models.PositiveIntegerField(verbose_name="Value of this requirement", default=0)
    ...
    active = models.BooleanField(verbose_name="Is this requirement active?",
