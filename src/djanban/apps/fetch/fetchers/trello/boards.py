...
class Initializer(TrelloConnector):
            ...
            if (
                ...
                for trello_list in trello_lists:
                    ...
                    if not board.lists.filter(uuid=trello_list.id).exists():
                        ...
                        if self.debug:
                            print(
                                f"- List {_list.name} of board {board_name} successfully created"
                            )
                        ...
                        if self.debug:
                            print(
                                f"- List {_list.name} of board {board_name} was already created"
                            )
    ...
    def fetch_members(self, board, trello_board):
        ...
        for trello_member in trello_members:
            ...
            if self.debug:
                print(
                    f"Member {member.external_username} has role {trello_member.member_type}"
                )
