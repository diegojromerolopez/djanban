...
def noise_level(current_user):
    ...
    chart_title = "Average noise levels per day in db as of {0}".format(timezone.now())
...
def noise_level_per_hour(current_user):
    ...
    chart_title = "Noise levels per hour in db as of {0}".format(timezone.now())
...
def noise_level_per_weekday(current_user):
    ...
    chart_title = "Noise levels per weekday in db as of {0}".format(timezone.now())
...
def subjective_noise_level(current_user, month=None, year=None):
    ...
    chart_title = "Subjective noise levels as of {0}".format(timezone.now())
