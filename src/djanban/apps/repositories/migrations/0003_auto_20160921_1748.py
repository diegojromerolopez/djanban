    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(
                default="",
                help_text="CI token used to clone and checkout the repository",
                max_length=128,
                verbose_name="CI token for the repository",
            ),
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                default="", max_length=128, verbose_name="Project userspace"
            ),
            preserve_default=False,
        ),
