...
def create_default_report_recipients(apps, schema):
    ...
    try:
        ...
        for administrator_user in administrator_users:
            if not ReportRecipient.objects.filter(
                email=administrator_user.email
            ).exists():
                report_recipient = ReportRecipient(
                    email=administrator_user.email, is_active=True
                )
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.EmailField(
                        max_length=254,
                        unique=True,
                        verbose_name="Email of the recipient",
                    ),
                ),
                (
                    "active",
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                ...
                default="",
                max_length=128,
                verbose_name="Name of this recipient",
            ),
        ),
        migrations.AddField(
            model_name="reportrecipient",
