...
#         )
    ...
    board = models.ForeignKey("boards.Board", verbose_name=u"Project", null=True, default=None, blank=True, on_delete=models.CASCADE)

    member = models.ForeignKey("members.Member", verbose_name=u"Who suffered the interruption", on_delete=models.CASCADE)
...
class NoiseMeasurement(models.Model):
    ...
    member = models.ForeignKey("members.Member", verbose_name=u"Who did take the measure?", on_delete=models.CASCADE)
