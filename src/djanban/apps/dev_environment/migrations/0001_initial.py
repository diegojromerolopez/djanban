    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cause",
                    models.TextField(
                        blank=True, default="", verbose_name="Why were you interrupted?"
                    ),
                ),
                (
                    "comments",
                    models.TextField(
                        blank=True,
                        default="",
                        verbose_name="Other comments about the interruption",
                    ),
                ),
                (
                    "board",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "datetime",
                    models.DateTimeField(verbose_name="When the measure was taken?"),
                ),
                (
                    "noise_level",
                    models.DecimalField(
                        decimal_places=4,
                        max_digits=12,
                        verbose_name="Noise level in decibeles",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                "library like",
                                "A whisper is heard perfectly (library like environment)",
                            ),
                            (
                                "distracting",
