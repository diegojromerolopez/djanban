    ...
    for daily_spent_time in DailySpentTime.objects.all():
        if daily_spent_time.spent_time is None:
            ...
            daily_spent_time.adjusted_spent_time = adjust_spent_time(
                daily_spent_time.member,
                daily_spent_time.spent_time,
                daily_spent_time.date,
            )
        DailySpentTime.objects.filter(id=daily_spent_time.id).update(
            adjusted_spent_time=daily_spent_time.adjusted_spent_time
        )
...
class Migration(migrations.Migration):
    ...
    operations = [migrations.RunPython(update_adjusted_spent_time)]
