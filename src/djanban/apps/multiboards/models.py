...
class Multiboard(models.Model):
    creator = models.ForeignKey("members.Member", on_delete=models.CASCADE, verbose_name="Member", related_name="created_multiboards")

    name = models.CharField(max_length=128, verbose_name="Name of the multiboard")

    description = models.TextField(max_length=128, verbose_name="Description of the multiboard", default="", blank=True)
    ...
    boards = models.ManyToManyField("boards.Board", verbose_name="Boards", related_name="multiboards")

    members = models.ManyToManyField("members.Member", verbose_name="Members", related_name="multiboards", blank=True)

    order = models.PositiveIntegerField(verbose_name="Order of this multiboard", default=1)
