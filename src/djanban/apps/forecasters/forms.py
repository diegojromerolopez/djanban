...
from djanban.apps.forecasters.regression.regressors import REGRESSION_MODELS
from djanban.apps.forecasters.regression.runner import RegressorRunner
...
class UpdateForecasterForm(forms.Form):
    confirm = forms.BooleanField(
        label="I want to update this forecaster", required=True
    )
