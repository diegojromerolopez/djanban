...
class Command(ReportCommand):
    ...
    def handle(self, *args, **options):
        ...
        subject = "[Djanban][Reports] Weekly report of {0}/W{1}".format(year, week)
        ...
        self.stdout.write(
            self.style.SUCCESS(
                "Weekly reports sent to {0} administrators".format(
        ...
        self.stdout.write(
            self.style.SUCCESS(
                "Weekly reports for week {0}/W{1} sent successfully to {2} in {3} s".format(
