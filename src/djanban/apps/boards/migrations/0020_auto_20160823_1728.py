...
def set_unique_public_access_code(apps, schema_editor):
    ...
    for board in Board.objects.all():
        board.public_access_code = "{0}{1}".format(
            shortuuid.ShortUUID().random(length=8), board.id
        ).lower()
        board.save()
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(
                default="",
                help_text="With this code it is possible to access to a view with stats of this board",
                max_length=32,
                verbose_name="External id of the board",
            ),
