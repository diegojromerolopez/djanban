...
def update_movement_count(apps, schema_editor):
    ...
    for card in Card.objects.all():
        ...
        card.number_of_backward_movements = card.movements.filter(
            type="backward"
        ).count()
        card.save()
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.PositiveIntegerField(
                default=0, verbose_name="Number of backward movements"
            ),
        ),
        migrations.AddField(
            model_name="card",
            ...
            field=models.PositiveIntegerField(
                default=0, verbose_name="Number of forward movements"
            ),
        ),
