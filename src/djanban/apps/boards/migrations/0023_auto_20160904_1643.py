    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.DateTimeField(
                default=datetime.datetime(2016, 9, 4, 14, 42, 59, 89990, tzinfo=utc),
        ...
        migrations.AddField(
            ...
            field=models.DateTimeField(
                default=datetime.datetime(2016, 9, 4, 14, 43, 23, 897965, tzinfo=utc),
                verbose_name="Last activity datetime",
            ),
            preserve_default=False,
        ),
    ]
