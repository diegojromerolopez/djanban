...
urlpatterns = (
    [
        ...
        url(
            r"^hourly_rates/",
            include("djanban.apps.hourly_rates.urls", namespace="hourly_rates"),
        ),
        url(r"^fetch/", include("djanban.apps.fetch.urls", namespace="fetch")),
        url(
            r"^forecasters/",
            include("djanban.apps.forecasters.urls", namespace="forecasters"),
        ),
        url(
            r"^environment/",
            include("djanban.apps.dev_environment.urls", namespace="dev_environment"),
        ),
        url(
            r"^multiboards/",
            include("djanban.apps.multiboards.urls", namespace="multiboards"),
        ),
        url(
            r"^notifications/",
            include("djanban.apps.notifications.urls", namespace="notifications"),
        ),
        url(r"^reports/", include("djanban.apps.reports.urls", namespace="reports")),
        url(
            r"^slideshow/",
            include("djanban.apps.slideshow.urls", namespace="slideshow"),
        ),
        url(r"^visitors/", include("djanban.apps.visitors.urls", namespace="visitors")),
        url(
            r"^niko-niko-calendar/",
            include(
                "djanban.apps.niko_niko_calendar.urls", namespace="niko_niko_calendar"
            ),
        ),
        url(
            r"^work-hours-packages/",
            include(
                "djanban.apps.work_hours_packages.urls", namespace="work_hours_packages"
            ),
        ),
        url(
            r"^async_include/", include("async_include.urls", namespace="async_include")
        ),
        url(
            r"^password-reset/",
            include("djanban.apps.password_reseter.urls", namespace="password_reseter"),
        ),
